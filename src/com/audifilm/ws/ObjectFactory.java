 ...
 * generated in the com.audifilm.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.audifilm.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.audifilm.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.audifilm.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.audifilm.com/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.audifilm.com/", name = "operacionResponse")

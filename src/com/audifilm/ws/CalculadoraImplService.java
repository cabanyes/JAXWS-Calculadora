 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.audifilm.com/", wsdlLocation = "http://localhost:8080/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.audifilm.com/", "CalculadoraImplService");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.audifilm.com/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.audifilm.com/", "CalculadoraImplPort"), Calculadora.class, features);
    }
